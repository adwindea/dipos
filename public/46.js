...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    store: function store() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.$apiAdress + '/api/mailSend/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token"), {
        email: self.email
  ...
  mounted: function mounted() {
    var self = this;
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.$apiAdress + '/api/prepareSend/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token")).then(function (response) {
